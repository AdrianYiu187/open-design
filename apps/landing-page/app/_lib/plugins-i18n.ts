...
const en: PluginsCopy = {
  ...
  contributeBody:
    "Every template, skill, and design system here is community-extensible. Add yours with a pull request — once it's merged it shows up in this catalogue and in the product automatically.",
  contributeCta: 'Contribute on GitHub →',
  contributeGuide: 'Read the contribution guide',
...
const overrides: Partial<Record<LandingLocaleCode, Partial<PluginsCopy>>> = {
  zh: {
    ...
    contributeBody:
      '这里的每个模板、skill、设计系统都可由社区扩展。提一个 pull request 加上你的——合并后会自动出现在这个目录和产品里。',
    contributeCta: '去 GitHub 贡献 →',
    contributeGuide: '阅读贡献指南',
    craftLabel: '插件 · 工艺',
  ...
  'zh-tw': {
    ...
    contributeBody:
      '這裡的每個範本、skill、設計系統都可由社群擴充。提一個 pull request 加上你的——合併後會自動出現在這個目錄和產品裡。',
    contributeCta: '前往 GitHub 貢獻 →',
    contributeGuide: '閱讀貢獻指南',
    craftLabel: '外掛 · 工藝',
